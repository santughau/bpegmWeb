...
if(isset($_GET['id'])){
        $id = $_GET['id'];
        $download = "SELECT * FROM result WHERE id = '$id' ";
    ...
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col-md-3 text-justify">
                <div class="card">
                    <div class="card-header bg-primary text-white text-center"><b>या माहितीचे संकलनकर्ते </b></div>
