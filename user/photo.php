...
if(isset($_GET['id'])){
    $del_id = $_GET['id'];    
    $del_query = "DELETE  FROM photo WHERE id = '$del_id'  ";
...
?>
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col-md-3 mb-4">
                <h2 class="text-center bg-primary text-white"> शालेय उपक्रमाची छायाचित्रे     </h2>
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group ">
                        <label class="text-danger"> शालेय उपक्रमाची विषय </label>
                        <input type="text" class="form-control" placeholder=" शालेय उपक्रमाची छायाचित्रे   लिहा " name="title" required> </div>
                    <div class="form-group ">
            ...
            <div class="col-md-9">
                <div class="table-responsive">
                    <h2 class="text-center bg-primary text-white"><i class="fa fa-download"></i> शालेय उपक्रमाची छायाचित्रे   </h2>
                    <table class="table table-bordered " id="table2excel">
                        <thead class="table-dark">
                            <tr>
                                <th scope="col">अ. क्र.</th>
                                <th scope="col">दिनांक </th>
                                <th scope="col"> शालेय उपक्रमाची छायाचित्रे </th>
                        ...
                        <tbody>
                            <?php
                           $download = "SELECT * FROM photo WHERE uploaderId = '$userId' ORDER BY id DESC ";
                            ...
                            while($row_download = mysqli_fetch_array($run_download)){
                                ...
                                $ia=$ia+1;
                                $whatsappLink = $baseUrl.'google-firebase-storage.php?id='.$download_id.'%26user='.$uploader_id;
                                ?>
                                <tr class="">
                                    <td>
                                        <?php echo $ia;?>
                                    ...
                                    <td class="align-middle"> <img src="https://drive.google.com/uc?export=view&id=<?php echo $download_link;?>" class="img-fulid" width="150" height="100" /> </td>
                                    ...
                                    <td><a href="editPhoto.php?id=<?php echo $download_id;?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                                    <td><a href="photo.php?id=<?php echo $download_id;?>" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                </tr>
                                <?php } ?>
                        </tbody>
                    </table>
  ...
  if(isset($_POST['submit'])){
      $title = $_POST['title'];
      $link = $_POST['link'];
      $insert_news = "INSERT INTO photo (date,subject,link,uploaderId,views) VALUES (NOW(),'$title','$link','$userId','0')";      
