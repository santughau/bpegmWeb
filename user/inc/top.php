...
?>
    ...
    <head>
        ...
        <meta itemprop="image" content="http://bpegm.in/images/<?php echo $ogImage ;?>">
        <!-- Twitter Card data -->
        ...
        <meta name="twitter:image:src" content="http://bpegm.in/images/<?php echo $ogImage ;?>">
        <!-- Open Graph data -->
        <meta property="og:title" content="<?php echo $title ;?>" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="http://bpegm.in/" />
        <meta property="og:image" itemprop="image" content="http://bpegm.in/images/<?php echo $ogImage ;?>" />
        <meta property="og:image:secure_url" content="http://bpegm.in/images/<?php echo $ogImage ;?>" />
