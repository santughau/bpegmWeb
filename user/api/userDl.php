<h2 class="text-center bg-primary text-white">मी  अपलोड  केलेली   प्रपत्रे  , PDF  , इत्यादी डाउनलोड करा  </h2>
<hr>
<table class="table table-bordered " id="table2excel">
    ...
    <tbody>
        <?php
                           $download = "SELECT * FROM generaldownload WHERE uploaderId = '$userId' ORDER BY id DESC ";
            ...
            <tr class="">
                ...
                <td><a href="google-liunx-hosting.php?id=<?php echo $download_id;?>" class="btn btn-primary" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
            </tr>
            <?php } ?>
    </tbody>
</table>