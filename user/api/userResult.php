<h2 class="text-center  text-white" style="background-color: #f40fd5">मी  अपलोड  केलेली  वेगवेगळ्या परीक्षेचे निकाल पहा   </h2>
<hr>
<table class="table table-bordered " id="table2excel4">
    ...
    <tbody>
        <?php
            ...
            <tr class="">
                ...
                <td><a href="devexpress-angular.php?id=<?php echo $download_id;?>" class="btn btn-primary" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
            </tr>
            <?php } ?>
    </tbody>
</table>