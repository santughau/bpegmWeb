...
?>
                        ...
                        <tbody>
                           ...
                           $download = "SELECT * FROM generaldownload WHERE uploaderId = '$userId' ORDER BY id DESC ";
                            ...
                            while($row_download = mysqli_fetch_array($run_download)){
                                ...
                                $ia=$ia+1;
                                $whatsappLink = $baseUrl.'google-liunx-hosting.php?id='.$download_id.'%26user='.$uploader_id;
                                ?>
                                <tr class="">
                                    <td>
                                        <?php echo $ia;?>
  ...
  if(isset($_POST['submit'])){
      $title = $_POST['title'];
      $link = $_POST['link'];
      $insert_news = "INSERT INTO generaldownload (date,subject,link,uploaderId,views) VALUES (NOW(),'$title','$link','$userId','0')";      
