...
if(isset($_GET['id'])){
    $del_id = $_GET['id'];    
    $del_query = "DELETE  FROM profarma WHERE id = '$del_id'  ";
...
?>
        ...
        <div class="row" style="margin-top:10px;">
            ...
            <div class="col-md-9">
                <div class="table-responsive">
                    <h2 class="text-center bg-primary text-white"><i class="fa fa-download"></i>शालेय  प्रपत्रे  </h2>
                    <table class="table table-bordered " id="table2excel">
                        ...
                        <tbody>
                            <?php
                           $download = "SELECT * FROM profarma WHERE uploaderId = '$userId' ORDER BY id DESC ";
                            ...
                            while($row_download = mysqli_fetch_array($run_download)){
                                ...
                                $whatsappLink = $baseUrl.'google-dns-tools.php?id='.$download_id.'%26user='.$uploader_id;
                                $ia=$ia+1;
                                ?>
                                <tr class="">
                                    <td>
                                    ...
                                    <td><a href="editProfarma.php?id=<?php echo $download_id;?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                                    <td><a href="profarma.php?id=<?php echo $download_id;?>" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                </tr>
                                <?php } ?>
                        </tbody>
                    </table>
  ...
  if(isset($_POST['submit'])){
      $title = $_POST['title'];
      $link = $_POST['link'];
      $insert_news = "INSERT INTO profarma (date,subject,link,uploaderId,views) VALUES (NOW(),'$title','$link','$userId','0')";      
