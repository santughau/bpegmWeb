...
?>
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col-md-3 mb-4">
                <h2 class="text-center bg-primary text-white">परीक्षेचे निकाल   </h2>
            ...
            <div class="col-md-9">
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered " id="table2excel">
                        ...
                        <tbody>
                            <?php
                           $download = "SELECT * FROM result WHERE uploaderId = '$userId' ORDER BY id DESC ";
                            ...
                            while($row_download = mysqli_fetch_array($run_download)){
                                ...
                                $whatsappLink = $baseUrl.'devexpress-angular.php?id='.$download_id.'%26user='.$uploader_id;
                                $ia=$ia+1;
                                ?>
                                <tr class="">
                                    <td>
                                    ...
                                    <td><a href="editResult.php?id=<?php echo $download_id;?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                                    <td><a href="result.php?id=<?php echo $download_id;?>" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                </tr>
                                <?php } ?>
                        </tbody>
                    </table>
  ...
  if(isset($_POST['submit'])){
      $title = $_POST['title'];
      $link = $_POST['link'];
      $insert_news = "INSERT INTO result (date,subject,link,uploaderId,views) VALUES (NOW(),'$title','$link','$userId','0')";      
