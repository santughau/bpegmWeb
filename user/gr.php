...
if(isset($_GET['id'])){
    ...
    if($del_run)
    {
       ...
       echo "<script>window.open('gr.php','_self')</script>";  
    }
}
?>
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col-md-3 mb-4">
                <h2 class="text-center bg-primary text-white"> शासकीय निर्णय    </h2>
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group ">
                        <label class="text-danger"> शासकीय निर्णय </label>
                        <input type="text" class="form-control" placeholder=" शासकीय निर्णय   लिहा " name="title" required> </div>
                    <div class="form-group ">
            ...
            <div class="col-md-9">
                <div class="table-responsive">
                    <h2 class="text-center bg-primary text-white"><i class="fa fa-download"></i> शासकीय निर्णय  </h2>
                    <table class="table table-bordered " id="table2excel">
                        ...
                        <tbody>
                            <?php
                           $download = "SELECT * FROM gr WHERE uploaderId = '$userId' ORDER BY id DESC ";
                            ...
                            while($row_download = mysqli_fetch_array($run_download)){
                                ...
                                $ia=$ia+1;
                                 $whatsappLink = $baseUrl.'godaddy-renewal-code.php?id='.$download_id.'%26user='.$uploader_id;
                                ?>
                                <tr class="">
                                    <td>
                                        <?php echo $ia;?>
                                    ...
                                    <td><a href="editGr.php?id=<?php echo $download_id;?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                                    <td><a href="gr.php?id=<?php echo $download_id;?>" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                </tr>
                                <?php } ?>
                        </tbody>
                    </table>
  ...
  if(isset($_POST['submit'])){
      $title = $_POST['title'];
      $link = $_POST['link'];
      $insert_news = "INSERT INTO gr (date,subject,link,uploaderId,views) VALUES (NOW(),'$title','$link','$userId','0')";      
