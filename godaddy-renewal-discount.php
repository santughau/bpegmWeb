<?php 
$page_title = "Godaddy Renewal Discount";
$page_key = "Godaddy Renewal Discount ";
$page_desc = "Godaddy Renewal Discount";
require_once('inc/db.php');
include('inc/top.php');
if(isset($_GET['id'])){
        $id = $_GET['id'];
        $download = "SELECT * FROM software WHERE id = '$id' ";
        ...
        $updateViews = "update software set 
        views = '$updatedViews'
        where id = '$id'";      
    ...
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top:10px;">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <blockquote class="blockquote mb-0">
                            ...
                            <div align="center"> <a href="https://chat.whatsapp.com/BrWghtzrhIqHGhSQ9ChQA9" class="btn btn-success" target="_blank"><i class="fa fa-whatsapp fa-4x"></i></a></div>
                        </blockquote>
                    </div>
                    <hr>
            ...
            <div class="col-md-9">
                ...
                <p class="text-justify" style="text-indent: 50px;">Recently we shared lots of <b>GoDaddy renewal discount </b>  for new domains, web hosting, and managed WordPress hosting. If you are looking for a new purchase, then you can check the latest Godaddy Hosting discount page for coupon codes.</p>
