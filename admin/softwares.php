...
if(isset($_GET['id'])){
    $del_id = $_GET['id'];    
    $del_query = "DELETE  FROM software WHERE id = '$del_id'  ";
    $del_run = mysqli_query($con,$del_query);
    if($del_run)
    {
       echo "<script>alert('You have been deleted successfully')</script>";
       echo "<script>window.open('softwares.php','_self')</script>";  
    }
}
?>
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col-md-3 mb-4">
                <h2 class="text-center bg-primary text-white">सॉफ्टवेअर्स   </h2>
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group ">
                        <label class="text-danger">सॉफ्टवेअर्स विषय लिहा </label>
            ...
            <div class="col-md-9">
                <div class="table-responsive">
                    <h2 class="text-center bg-primary text-white"><i class="fa fa-download"></i> सॉफ्टवेअर्स इत्यादी </h2>
                    <table class="table table-bordered " id="table2excel">
                        <thead class="table-dark">
                            <tr>
                                <th scope="col">अ. क्र.</th>
                                <th scope="col">दिनांक </th>
                                <th scope="col">सॉफ्टवेअर्स विषय </th>
                           ...
                           $download = "SELECT * FROM software ORDER BY id DESC ";
                            ...
                            while($row_download = mysqli_fetch_array($run_download)){
                                ...
                                <tr class="">
                                    ...
                                    <td><a href="editSoftware.php?id=<?php echo $download_id;?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                                    <td><a href="softwares.php?id=<?php echo $download_id;?>" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                </tr>
                                <?php } ?>
                        </tbody>
                    </table>
  ...
  if(isset($_POST['submit'])){
      $title = $_POST['title'];
      $link = $_POST['link'];
      $insert_news = "INSERT INTO software (date,subject,link,uploaderId,views) VALUES (NOW(),'$title','$link','2','0')";      
