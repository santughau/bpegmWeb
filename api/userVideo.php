<h2 class="text-center bg-success text-white">मी  अपलोड  केलेली  व्हिडिओ   डाउनलोड करा  </h2>
<hr>
<table class="table table-bordered " id="table2excel8">
    ...
    <tbody id="">
        <?php
                           $download = "SELECT * FROM video WHERE uploaderId = '$id' ORDER BY id DESC ";
            ...
            <tr class="text-center align-text-top">
                ...
                <td class="align-middle"><a href="adobe-photoshop.php?id=<?php echo $download_id;?>" class="btn btn-primary" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
            </tr>
            <?php } ?>
    </tbody>
</table>