    ...
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col-md-3 text-justify">
                <div class="card">
                    <div class="card-header bg-primary text-white text-center"><b> पुस्तक करीत संपर्क  करा :  97659 43144  </b></div>
                    <div class="card-body">
                        <img src="images/book.jpg" class="img-fluid"  />
                    </div>
                    
                    <div class=" col-md-12" style="background-color: #f9f0f7">
                         <img class="img-fluid" src="images/173.jpg" width="150" align="left" vspace="5" hspace="5" />
                        <h4 class="text-center text-danger">जैपाल भैय्यालाल ठाकूर , गोंदिया</h4>
                        <h6 class="text-center"> जि. प. वरिष्ठ प्राथमिक शाळा भोसा,  पं. स.आमगाव , जि.प. गोंदिया</h6> </div>
                </div>
               
                <h2 class="text-center bg-primary text-white"> <?php echo $name;?>  </h2>
                
                <div align="center"> <a class="btn btn-danger" href="redhat-linux.php?id=<?php echo $download_id;?>" target="_blank">येथे क्लिक करा </a>
